...
// Define content type for messages
type ContentItem =
    ...
    <section>
      ...
      <div className="flex flex-col relative">
        ...
        <header className="relative z-10">
          <h1 className="text-center font-semibold md:text-5xl sm:text-4xl text-3xl mb-2">Chat with Programmer AI</h1>
        </header>
        {/* chat box */}
        ...
        <div className=" bottom-4 left-4 z-10">
          <Link href="/dashboard/ProgrammerAI/avatar">
